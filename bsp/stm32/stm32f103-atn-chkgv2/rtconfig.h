...
#define PKG_EASYFLASH_LOG_AREA_SIZE 516096
...
#define BSP_USING_AT_CAT1
#define EC200X_CLIENT_NAME "uart3"
#define EC200X_POWER_PIN -1
#define EC200X_STATUS_PIN -1
#define EC200X_WAKEUP_PIN -1
